...
namespace BehaviorSwitchboard::ConfigLoader {

    static constexpr const char* kConfigDir = "Data/SKSE/Plugins/BehaviorSwitchboard";
    ...
    static std::optional<Registration> LoadIni(const std::filesystem::path& path)
    {
        LOG_WARN("ConfigLoader: '{}' uses the deprecated .ini format. "
                 ...
                 "in a future version. See the BSB documentation for the new format.",
            path.filename().string());

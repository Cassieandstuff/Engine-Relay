...
namespace BehaviorSwitchboard {
    ...
    inline constexpr std::string_view kGateVarNames[] = {
        "BSB_Gate_WeaponDraw",      // ActionGate::WeaponDraw
        "BSB_Gate_WeaponSheathe",   // ActionGate::WeaponSheathe
        "BSB_Gate_WeaponEquip",     // ActionGate::WeaponEquip
        "BSB_Gate_CutsceneActions", // ActionGate::CutsceneActions
    };
    ...
    ///     2. The pending BSB event (set by SetPendingBSBEvent before
    ...
    namespace BehaviorPatcher {
        ...
        /// Thread-safe. Called from BSB_API::Register() and ConfigLoader.
        ...
        /// Must be called BEFORE actor->NotifyAnimationGraph() so that BSB_Activate
